...
function Landing() {
  ...
  return (
    <main className="bg-(--bg-color) text-slate-100">
      <SEO
      ...
      <div className="w-screen h-screen flex items-center flex-col">
        <nav className="w-6/7 h-15 flex items-center justify-between p-2">
          <div className="h-full">
            <img className=" h-full " src={myImages.logo} />
          </div>
          <div className="flex gap-2">
            <button
              className=" h-9 border-b-3 border-(--buttonSelected)/0 hover:border-(--buttonSelected) p-2 font-semibold text-sm transition-all ease-in-out"
              onClick={() => navigate("/")}
            >
              Dashboard
            </button>
            <Button
              ...
              selected
              width={"w-auto font-semibold "}
            >
              Login
            </Button>
          </div>
        </nav>
        <main className="flex flex-col md:flex-row w-6/7 h-full">
          <div className="w-full max h-full flex flex-col items-center justify-center gap-3">
            <h1 className="text-3xl font-semibold leading-tight text-(--textPrimary) sm:text-5xl bg-blue">
              Create custom QR codes and measure their impact in real time
            </h1>
            <p className=" text-lg text-slate-300 ">
              JeviQR combines design, automation, and analytics so you can
              launch dynamic QR campaigns, track conversions, and scale your
              omnichannel presence without friction.
            </p>
          </div>
          <div className="w-full h-full flex items-center justify-center">
            <img src={myImages.landing} />
          </div>
        </main>
        <footer className="w-full h-15 bg-(--buttonSelected)"></footer>
      </div>
        ...
        <div>
          <header className="mx-auto flex max-w-6xl flex-col gap-12 px-6 py-24 lg:flex-row lg:items-center">
            ...
            <div className="flex-1 rounded-2xl border border-slate-800 bg-slate-900/40 p-8 text-sm leading-relaxed text-slate-300 shadow-2xl shadow-slate-900/30">
              ...
              <p className="mt-4">
                ...
                templates. Instantly connect welcome flows, offers, and surveys
                to every scan and trigger alerts when campaigns outperform
                goals.
              </p>
          ...
          >
            <div className="space-y-3">
              ...
              <p className="text-slate-300">
                Everything you need to launch, optimize, and scale campaigns
                with QR codes from a single workspace.
              </p>
            </div>
            <div className="grid gap-8 md:grid-cols-2">
              <article className="rounded-xl border border-slate-800 bg-slate-900/40 p-6">
                ...
                <p className="mt-3 text-sm text-slate-300">
                  Customize colors, shapes, and logos, apply templates, and
                  export in formats ready for print or digital displays.
                </p>
              </article>
              <article className="rounded-xl border border-slate-800 bg-slate-900/40 p-6">
                <h3 className="text-xl font-semibold text-white">
                ...
                <p className="mt-3 text-sm text-slate-300">
                  Redirect scans to tailored campaigns, trigger notifications,
                  and connect to your stack through no-code integrations.
                </p>
              </article>
              <article className="rounded-xl border border-slate-800 bg-slate-900/40 p-6">
                <h3 className="text-xl font-semibold text-white">
          ...
          <section className="bg-slate-900 py-16">
            <div className="mx-auto flex max-w-5xl flex-col gap-8 px-6 text-center text-slate-100">
              ...
              <p className="mx-auto max-w-3xl text-slate-300">
                Retail, restaurants, events, education, or experiential
                marketing. JeviQR helps you transform every touchpoint into
                measurable, updatable experiences in seconds.
              </p>
            </div>
          </section>
          <footer className="mx-auto flex max-w-5xl flex-col items-center gap-4 px-6 py-16 text-center text-slate-200">
            ...
            <p className="max-w-3xl text-slate-300">
              Get started for free in minutes and scale into automated flows
              with advanced analytics as your campaign grows.
            </p>
            <a
              className="inline-flex items-center justify-center rounded-lg bg-teal-500 px-6 py-3 text-base font-semibold text-slate-950 transition hover:bg-teal-400"
              href="/login"
